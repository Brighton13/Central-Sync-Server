module.exports = (sequelize, DataTypes) => {
  const reconSale = sequelize.define('reconSale', {
    ...
    zra_sdc_id: { type: DataTypes.STRING(100), allowNull: true },
    zra_receipt_number: { type: DataTypes.STRING(100), allowNull: true },
    zra_status: { type: DataTypes.STRING(50), allowNull: false, defaultValue: 'pending' },
    zra_invoice_number: { type: DataTypes.STRING(100), allowNull: true },
    zra_signature: { type: DataTypes.STRING(255), allowNull: true },
    zra_internal_data: { type: DataTypes.STRING(255), allowNull: true },
    zra_qr_url: { type: DataTypes.TEXT, allowNull: true },
    zra_qr_file_path: { type: DataTypes.STRING(500), allowNull: true },
    receipt_printed: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
    has_sdc_data: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
    has_qr_artifact: { type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false },
    ...
    indexes: [
      ...
      { name: 'idx_recon_sales_sdc_date', fields: ['has_sdc_data', 'sale_date'] },
    ],
  });
